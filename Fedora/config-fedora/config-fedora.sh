...
config_dnf(){
	echo -e "\033[1;32m==========DNF configuration==========\033[0m"
...
maj(){
    ...
    dpkg --configure -a
    echo ""
	echo "\033[1;32mFlatpak upgrade\033[0m"
	echo ""
	flatpak update -y
	echo ""
	echo "\033[1;32mSystem upgrade\033[0m"
	echo ""
	dnf upgrade -y
	echo ""
	dnf clean packages
...
install_app(){
	echo -e "\033[1;32m==========Installing softwares==========\033[0m"
	echo ""
	echo -e "\033[1;32mInstallation of RPM Fusion components\033[0m"
	echo ""
	...
	echo ""
	echo -e "\033[1;32mInstallation of codecs\033[0m"
	echo ""
	...
	echo ""
	echo -e "\033[1;32mSoftware installation\033[0m"
	echo ""
	dnf install --skip-unavailable -y $ADDAPP
	echo ""
	echo -e "\033[1;32mInstalling the GNOME components\033[0m"
	echo ""
